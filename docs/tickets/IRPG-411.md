...
- 완료: engine 협공 event·RNG/보상 불변, 최근 20개 selector·unknown fallback·5초 fake-clock announcement component 테스트
- 완료: 360px keyboard/filter/reload/offline과 200%·reduced-motion Playwright 3개 로컬 Chromium 통과
- 대기: 32개 Ubuntu canonical 생성·3회 반복 안정성 artifact와 전체 `npm run verify`
