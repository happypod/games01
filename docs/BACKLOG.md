...
| IRPG-416 | 동적 전투 연출·비노출 전투 손상 | P1 | Test | 106,108,403,410,413,415,506 | ART-2D, FE-GAME, UX-FEEDBACK, QA-E2E | 전투 이벤트에 맞춘 동작·플로팅 수치·필살기 연출과 안전한 3단계 갑옷 손상이 저장·전투 결과를 바꾸지 않고 표시된다. |
