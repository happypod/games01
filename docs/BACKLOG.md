...
| IRPG-417 | 전술 전장 연출 가시성·원정 오버레이 접기 | P1 | Test | 403,412,415,416,506 | FE-GAME, UX-FEEDBACK, QA-E2E | 저장된 원정 이벤트가 있어도 전장을 먼저 표시하고 필요할 때만 선택 오버레이를 열며 갑옷 손상 단계를 명확히 설명한다. |
