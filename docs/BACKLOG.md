...
| IRPG-414 | 데스크톱 원 뷰 대시보드 | P1 | Test | 401,403,407,408,409,410,411,412,506 | FE-GAME, UX-FEEDBACK, QA-E2E | 1024px 이상에서 문서 스크롤 없이 전투·원정·성장을 한 화면에서 조작하고 360px 세로 흐름을 보존한다. |
