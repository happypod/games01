...
| IRPG-106 | 결정론적 전투 이벤트 스트림 | P1 | Done | 103,104,505 | ENG-STATE, ENG-SIM, QA-DOMAIN | 치명타·스킬·처치·보스 승리·패배 이벤트 순서가 재현된다. |
...
| IRPG-506 | 시각 브라우저 회귀 게이트 | P1 | Ready | 403,504,406,407,413,507 | QA-E2E, REL-CI, ART-DIR | 기본 전투 시각 상태의 screenshot harness를 만들고 후속 UI가 baseline을 확장한다. |
