...
- `result/shared-result-placeholder.webp`: 1280×720 historical centered outcome seal; no production manifest ID references it after IRPG-410.
...
The hero placeholder was replaced by the final IRPG-407 generated illustration. Its production record is `hero-ashen-knight.md`. The two result placeholders were replaced by final IRPG-410 illustrations recorded in `battle-results.md`.
