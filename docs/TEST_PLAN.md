...
| 시각 회귀 | 구현 | Ubuntu 24.04·고정 Chromium/font/time/seed에서 17 named fixture × 4 viewport/motion variant, state/event hash, overflow·motion, screenshot diff artifact |
